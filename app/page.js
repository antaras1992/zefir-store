    ...
    <div className={styles.wrap}>
      ...
      <nav className={styles.nav}>
        ...
        <div className={styles.navRight}>
          <a className={styles.socialBtn} href="https://www.instagram.com/handmade_zefir_canada" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <a className={styles.socialBtn} href="https://www.facebook.com/share/1FeZwWCENb/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
